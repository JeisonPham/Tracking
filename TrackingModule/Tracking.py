...
class Track:
    def __init__(self, label, starting, clock):
        """
        starting is a array of (x, y, u, v, theta) where x, y are position, u, v are velocity in each direction and vehicle angle
        """
        self.label = label
...
class Tracker:
    ...
    def __call__(self, T1, D, labels=None, clock=0):
        ...
        other bounding box attributes q, tracking id id,
